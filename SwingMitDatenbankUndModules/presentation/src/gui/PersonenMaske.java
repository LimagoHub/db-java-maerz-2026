...
public class PersonenMaske extends JFrame {
    ...
    private final PersonenTableAdapter tableAdapter = new PersonenTableAdapter();
    ...
    public PersonenMaske() throws HeadlessException {
        ...
        personenTabelle = new JTable(tableAdapter);
        ...
        add(new JScrollPane(personenTabelle), BorderLayout.CENTER);
    }
